...
import { ICloudApiClient, InsufficientCreditsError, CloudAuthError } from '../cloudApiClient';
import {
...
class WebSearchTool implements vscode.LanguageModelTool<WebSearchToolInput> {
	constructor(private readonly apiClient: ICloudApiClient) { }
 ...
 */
export function registerBraveSearchTools(apiClient: ICloudApiClient): vscode.Disposable {
