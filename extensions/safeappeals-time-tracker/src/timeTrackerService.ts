...
export class TimeTrackerService {
	...
	constructor(
		...
		private readonly sensitiveStateStore: SensitiveStateStore
	) {
	...
	private restoreState(): void {
		const savedState = this.sensitiveStateStore.getTimerState();
	...
	private persistState(): void {
		this.sensitiveStateStore.setTimerState(this.timerState);
	}
