...
(() => {
  ...
  // webview-src/shared/vscodeApi.ts
  ...
  var EVENT_CATEGORIES = Object.keys(EVENT_CATEGORY_LABELS);
  ...
  function isDeadlineUpcoming(event, daysAhead) {
    ...
    const daysUntil = daysBetween(/* @__PURE__ */ new Date(), deadline);
    return daysUntil >= 0 && daysUntil <= daysAhead;
  }
  function isDeadlineOverdue(event) {
    if (!event.isDeadline || event.isComplete) {
      return false;
    }
    const deadline = new Date(event.date);
  ...
  function EventEditorModal(props) {
    ...
    const [date, setDate] = (0, import_react.useState)(dateOnly(event?.date ?? (/* @__PURE__ */ new Date()).toISOString()));
    const [endDate, setEndDate] = (0, import_react.useState)(dateOnly(event?.endDate ?? ""));
    const [category, setCategory] = (0, import_react.useState)(event?.category ?? "custom");
    const [isDeadline, setIsDeadline] = (0, import_react.useState)(event?.isDeadline ?? false);
    const [isComplete, setIsComplete] = (0, import_react.useState)(event?.isComplete ?? false);
    const [reminderDays, setReminderDays] = (0, import_react.useState)(() => {
      if (event?.isDeadline) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "modal-backdrop", role: "presentation", onClick: onCancel, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        className: "modal",
        role: "dialog",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { id: "event-editor-title", children: event ? "Edit Event" : "Add Event" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-body", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "field-label", children: [
              "Title",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { className: "field", value: title, onChange: (e) => setTitle(e.target.value) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "field-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "field-label", children: [
                "Date",
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { className: "field", type: "date", value: date, onChange: (e) => setDate(e.target.value) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "field-label", children: [
                "End date",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "field-label", children: [
              "Category",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { className: "field", value: category, onChange: (e) => setCategory(e.target.value), children: EVENT_CATEGORIES.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: c, children: EVENT_CATEGORY_LABELS[c] }, c)) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "field-label", children: [
              "Description",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "check-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
                {
                  type: "checkbox",
            ...
            isDeadline && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "check-row", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "input",
                  {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "linked-docs-editor", "aria-label": "Linked documents", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "linked-docs-header", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "field-label-text", children: "Linked documents" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "linked-docs-actions", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "button",
                    {
                      type: "button",
              ...
              linkedDocuments.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "linked-docs-empty", children: "No documents linked yet." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "linked-docs-list", children: linkedDocuments.map((uri) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: "linked-docs-item", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
                  {
                    type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "btn btn-secondary", onClick: onCancel, children: "Cancel" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                type: "button",
  ...
  function DeadlineBanner(props) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "deadline-banners", children: [
      overdue.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "deadline-kicker", children: "Overdue" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "deadline-title", children: e.title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "deadline-date", children: formatTimelineDate(e.date) })
          ]
        },
        e.id
      )),
      upcoming.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "button",
        {
          type: "button",
          ...
          onClick: () => props.onSelect(e.id),
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "deadline-kicker", children: "Due soon" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "deadline-title", children: e.title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "deadline-date", children: formatTimelineDate(e.date) })
          ]
        },
  ...
  function EventCard(props) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rail", children: [
            !props.isFirst && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rail-line top" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rail-dot", style: { background: color, boxShadow: overdue ? "0 0 0 2px var(--vscode-inputValidation-errorBorder)" : void 0 } }),
            !props.isLast && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rail-line bottom" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { className: "event-card", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "event-card-main", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "event-meta", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "event-date", children: formatTimelineDate(event.date) }),
                event.isDeadline && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "pill deadline", children: "Deadline" }),
                event.isComplete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "pill complete", children: "Complete" }),
                event.source && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "pill source", children: event.source })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "event-title", children: event.title }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "category-chip", style: { background: color }, children: EVENT_CATEGORY_LABELS[event.category] }),
              event.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "event-description", children: event.description }),
              event.linkedDocuments.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "linked-docs", children: event.linkedDocuments.map((uri) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
                  type: "button",
                  className: "btn btn-secondary btn-sm",
                  ...
                  children: uri.split("/").pop() || uri
                }
              ) }, uri)) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "event-actions", onClick: (e) => e.stopPropagation(), children: [
              event.isDeadline && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "btn btn-secondary", onClick: props.onToggleComplete, children: event.isComplete ? "Reopen" : "Complete" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "btn btn-secondary", onClick: props.onEdit, children: "Edit" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "btn btn-secondary", onClick: props.onDelete, children: "Delete" })
            ] })
          ] })
        ]
      }
  ...
  function App() {
    ...
    const sortedEvents = (0, import_react.useMemo)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dashboard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "toolbar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "toolbar-summary", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "toolbar-title", children: "Case Timeline" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "toolbar-meta", children: [
            workspaceName,
            " \xB7 ",
            jurisdictionLabel,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "toolbar-actions", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "all", children: "All categories" }),
                EVENT_CATEGORIES.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: c, children: EVENT_CATEGORY_LABELS[c] }, c))
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "check-row toolbar-check", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "chronology", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeadlineBanner, { events: sortedEvents, onSelect: focusEvent }),
        needsSetup && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "setup-hint", children: "Set jurisdiction and injury date in the Timeline sidebar." }),
        filteredEvents.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "empty-state", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "empty-title", children: "No chronology yet" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: needsSetup ? "Set jurisdiction and injury date in the Timeline sidebar to get started." : "Add an event to begin the case chronology, or use the Timeline sidebar for filters and setup." }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              type: "button",
        ...
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "chronology-rail", children: filteredEvents.map((event, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          EventCard,
          {
            event,
            isFirst: index === 0,
