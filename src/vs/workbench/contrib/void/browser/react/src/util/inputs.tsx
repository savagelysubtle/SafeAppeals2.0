				...
				{isMenuOpen && (
					...
					>
						...
						{isBreadcrumbsShowing && (
							<div
								className="px-2 py-1 border-b border-void-border-3 sticky top-0 z-10 select-none pointer-events-none"
								style={{
									backgroundColor:
										"var(--vscode-menu-background, var(--vscode-editorWidget-background, var(--void-bg-2, #1e1e1e)))",
									color:
								...
								options.map((o, oIdx) => {
									return (
										...
										<div
											...
											key={o.fullName}
											className="flex items-center gap-2 px-3 py-1 cursor-pointer transition-all duration-100 hover:opacity-90"
											style={{
												width: "100%",
												backgroundColor:
													oIdx === optionIdx
										...
										>
											...
											{o.fullName && o.fullName !== o.abbreviatedName && (
												<span className="opacity-60 text-sm">{o.fullName}</span>
											)}
				...
				<div className="relative w-full">
					...
					<div
						className={`absolute top-1/2 transform -translate-x-1/2 -translate-y-1/2
							...
							bg-void-fg-1 rounded-full shadow-md ${
								disabled
									? "cursor-not-allowed"
...
export const VoidButtonBgDarken = ({
	...
	return (
		<button
			...
			${
				disabled || loading
					? "void-opacity-50 void-cursor-not-allowed"
					: "void-cursor-pointer hover:void-brightness-110"
			}
			${className || ""}
		`}
			onClick={onClick}
