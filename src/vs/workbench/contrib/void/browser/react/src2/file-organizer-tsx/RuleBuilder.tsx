...
export const RuleBuilder: React.FC<RuleBuilderProps> = ({
  ...
  const getPreviewName = useCallback(
    (file: any) => {
      ...
      let fileType = "File";
      if (file.name.toLowerCase().includes("wireframe")) fileType = "Wireframe";else
      if (file.name.toLowerCase().includes("mockup")) fileType = "Mockup";else
      if (file.name.toLowerCase().includes("medical"))
      fileType = "Medical";else
      if (file.name.toLowerCase().includes("legal")) fileType = "Legal";else
      if (file.name.toLowerCase().includes("correspondence"))
      fileType = "Correspondence";else
