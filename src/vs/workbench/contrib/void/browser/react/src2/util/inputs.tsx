...
import {
  IInputBoxStyles,
  InputBox } from
"../../../../../../../base/browser/ui/inputbox/inputBox.js";
...
import {
  ...
  defaultSelectBoxStyles } from
"../../../../../../../platform/theme/browser/defaultStyles.js";
...
import {
  inputBackground,
  inputForeground } from
"../../../../../../../platform/theme/common/colorRegistry.js";
import { asCssVariable } from "../../../../../../../platform/theme/common/colorUtils.js";
import { StagingSelectionItem } from "../../../../common/chatThreadServiceTypes.js";
import {
  ExtractedSearchReplaceBlock,
  extractSearchReplaceBlocks } from
"../../../../common/helpers/extractCodeFromResult.js";
...
export const WidgetComponent = <CtorParams extends any[], Instance>({
  ...
  onCreateInstance: (instance: Instance) => IDisposable[];dispose: (instance: Instance) => void;children?: React.ReactNode;className?: string;}) => {const containerRef = useRef<HTMLDivElement | null>(null);
  ...
  return (
    <div
      ref={containerRef}
      className={className === undefined ? `void-w-full` : className}>
    ...
    return (
      <>
        ...
        <div
          ...
          className="void-border-void-border-3 void-border void-rounded void-shadow-lg"
          style={{
            zIndex: 10000,
            position: strategy,
            top: y ?? 0,
            ...
            0,
            backgroundColor:
            "var(--vscode-menu-background, var(--vscode-editorWidget-background, var(--void-bg-2, #1e1e1e)))",
            color:
            "var(--vscode-menu-foreground, var(--vscode-editorWidget-foreground, var(--void-fg-1, #cccccc)))"
          }}
          ...
          <div
            className="void-px-2 void-py-1 void-border-b void-border-void-border-3 void-sticky void-top-0 void-z-10 void-select-none void-pointer-events-none"
            style={{
              backgroundColor:
              "var(--vscode-menu-background, var(--vscode-editorWidget-background, var(--void-bg-2, #1e1e1e)))",
              color:
            ...
            <div className="void-opacity-50">Enter text to filter...</div>
						...
						{/* Options list */}
						<div
            className="void-overflow-auto void-max-h-80"
            style={{
              backgroundColor:
              "var(--vscode-menu-background, var(--vscode-editorWidget-background, var(--void-bg-2, #1e1e1e)))",
              color:
              "var(--vscode-menu-foreground, var(--vscode-editorWidget-foreground, var(--void-fg-1, #cccccc)))"
							...
							{options.length === 0 ?
            <div
              className="void-px-3 void-py-0.5"
              style={{
                color:
                "var(--vscode-menu-foreground, var(--vscode-editorWidget-foreground, var(--void-fg-1, #cccccc)))"
              }}>
            ...
            options.map((o, oIdx) => {
              return (
                ...
                <div
                  ...
                  key={o.fullName}
                  className="void-flex void-items-center void-gap-2 void-px-3 void-py-1 void-cursor-pointer void-transition-all void-duration-100 hover:void-opacity-90"
                  style={{
                    width: "100%",
                    backgroundColor:
                    oIdx === optionIdx ?
                    "var(--vscode-menu-selectionBackground, var(--vscode-editorWidget-background, #2a2a2a))" :
                    "var(--vscode-menu-background, var(--vscode-editorWidget-background, var(--void-bg-2, #1e1e1e)))",
                    color:
                    oIdx === optionIdx ?
                    "var(--vscode-menu-selectionForeground, var(--vscode-editorWidget-foreground, #ffffff))" :
                    "var(--vscode-menu-foreground, var(--vscode-editorWidget-foreground, var(--void-fg-1, #cccccc)))"
                  }}
                  onClick={() => {
                    onSelectOption();
                  ...
                  <span className="void-opacity-60 void-text-sm">{o.fullName}</span>
                  }
        ...
        style={{
          ...
          // paddingRight: thumbSizePx / 2
            ...
            onClick={handleTrackClick}>
						...
						<div
              className={`void-absolute void-left-0 ${
              size === "xxs" ? "void-h-0.5" :
...
}: {label: string;value: boolean;onClick: (checked: boolean) => void;className?: string;}) => {
  ...
  return (
    <div className={`void-inline-block void-relative ${className}`}>
        ...
        aria-hidden="true">
          ...
          return (
            <div
              ...
              className="void-flex void-items-center void-whitespace-nowrap">
        ...
        onClick={() => setIsOpen(!isOpen)}>
				...
				<svg
          className={`void-size-3 void-flex-shrink-0 ${
          arrowTouchesText ? "" : "void-ml-auto"}`}
        ...
        onWheel={(e) => e.stopPropagation()}>
          ...
          style={{
            ...
            return (
              <div
                key={optionName}
                className={`void-flex void-items-center void-px-2 void-py-1 void-pr-4 void-cursor-pointer void-whitespace-nowrap void-transition-all void-duration-100 hover:void-opacity-90`}
                style={{
                  width: "100%",
...
export const BlockCode = ({
  ...
  return (
    <div ref={divRef} className="void-relative void-z-0 void-px-2 void-py-1 void-bg-void-bg-3">
			<WidgetComponent
...
export const VoidButtonBgDarken = ({
...
}: {children: React.ReactNode;disabled?: boolean;onClick: () => void;className?: string;loading?: boolean;tooltip?: string;variant?: "default" | "primary" | "danger";}) => {
  const variantClasses = {
    default: "void-bg-black/10 dark:void-bg-white/10",
    primary:
    "void-bg-void-button-primary hover:void-bg-void-button-primary-hover void-text-void-button-primary-text",
  ...
  return (
    <button
      ...
      className={` void-void-px-3 void-void-py-1 void-void-rounded-sm void-void-overflow-hidden void-void-whitespace-nowrap void-void-flex void-void-items-center void-void-justify-center void-void-gap-2 void-void-transition-all void-void-duration-200 ${


      variantClasses[variant]} ${

      disabled || loading ? "void-void-opacity-50 void-void-cursor-not-allowed" : "void-void-cursor-pointer hover:void-void-brightness-110"} ${
      ...
      data-tooltip-content={tooltip}>
			...
			{loading && <Loader2 size={14} className="void-void-animate-spin" />}
			{children}
		</button>);
...
const SingleDiffEditor = ({
...
}: {block: ExtractedSearchReplaceBlock;lang: string | undefined;}) => {
  const accessor = useAccessor();
  const modelService = accessor.get("IModelService");
  const instantiationService = accessor.get("IInstantiationService");
  const languageService = accessor.get("ILanguageService");
  ...
  return (
    <div
      className="void-w-full void-bg-void-bg-3 bg-editor-style-override"
      ref={divRef} />);
...
export const VoidDiffEditor = ({
...
}: {uri?: any;searchReplaceBlocks: string;language?: string;}) => {
  const accessor = useAccessor();
  const languageService = accessor.get("ILanguageService");
  ...
  if (blocks.length === 0) {
    return (
      <div className="void-w-full void-p-4 void-text-void-fg-4 void-text-sm">No changes found</div>);
