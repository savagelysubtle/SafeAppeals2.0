...
import { useGrowthWriter, Campaign, SocialPost, SILO_LABELS } from '../shared/GrowthWriterContext.js';
    ...
    <div style={{ padding: '16px' }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
          ...
          <tr
            ...
            onClick={() => openView('social-posts', { campaignId: c.id, label: c.title || c.silo })}>
            
								<td style={tdStyle}><SiloBadge silo={c.silo} /></td>
								<td style={{ ...tdStyle, fontWeight: 500 }}>{c.title || 'Untitled'}</td>
