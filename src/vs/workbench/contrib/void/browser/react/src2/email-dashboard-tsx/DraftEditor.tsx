...
export const DraftEditor: React.FC<DraftEditorProps> = ({
  ...
  return (
    <div className="void-draft-editor-container">
			{/* Header */}
			<div className="void-draft-editor-header">
				<div className="void-draft-editor-title">
					<i className="void-codicon void-codicon-edit" />
					<span>Draft Reply</span>
					{hasUnsavedChanges &&
          <span className="void-draft-editor-unsaved">•</span>
          }
					{/* Status Badge */}
					{draftId &&
          <div style={{ marginLeft: '12px' }}>
              ...
              onStatusChange={handleStatusChange} />
				...
				<div className="void-draft-editor-header-actions">
          ...
          <button
            ...
            className="void-draft-editor-status-btn"
            ...
            style={{
              ...
              opacity: isUpdatingStatus || hasUnsavedChanges ? 0.6 : 1
							...
							<i className={`void-codicon ${isUpdatingStatus ? "void-codicon-loading void-codicon-modifier-spin" : "void-codicon-arrow-right"}`} />
							<span>{nextStatusAction.label}</span>
						</button>
          }
					<span className="void-draft-editor-last-saved">
						{isSaving ? 'Saving...' : `Saved ${formatLastSaved(lastSaved)}`}
					</span>
					<button
            onClick={() => setShowVersionHistory(!showVersionHistory)}
            className="void-draft-editor-history-btn"
            ...
            className="void-draft-editor-save-btn"
            title="Save draft (Ctrl+S)">
            
						<i className={`void-codicon ${isSaving ? "void-codicon-loading void-codicon-modifier-spin" : "void-codicon-save"}`} />
						<span>Save</span>
					</button>
					{onClose &&
          <button
            onClick={onClose}
            className="void-draft-editor-close-btn"
            title="Close editor">
			...
			{/* Toolbar */}
			<div className="void-draft-editor-toolbar">
				{/* Text formatting */}
				<div className="void-draft-editor-toolbar-group">
					<button onClick={setParagraph} title="Normal text" className="void-draft-editor-toolbar-btn">
						<i className="void-codicon void-codicon-symbol-text" />
					</button>
					<button onClick={() => setHeading(1)} title="Heading 1" className="void-draft-editor-toolbar-btn">
						<span style={{ fontWeight: 'bold' }}>H1</span>
					</button>
					<button onClick={() => setHeading(2)} title="Heading 2" className="void-draft-editor-toolbar-btn">
						<span style={{ fontWeight: 'bold' }}>H2</span>
					</button>
					<button onClick={() => setHeading(3)} title="Heading 3" className="void-draft-editor-toolbar-btn">
						<span style={{ fontWeight: 'bold' }}>H3</span>
					</button>
				</div>

				<div className="void-draft-editor-toolbar-divider" />

				{/* Style formatting */}
				<div className="void-draft-editor-toolbar-group">
					<button onClick={toggleBold} title="Bold (Ctrl+B)" className="void-draft-editor-toolbar-btn">
						<i className="void-codicon void-codicon-bold" />
					</button>
					<button onClick={toggleItalic} title="Italic (Ctrl+I)" className="void-draft-editor-toolbar-btn">
						<i className="void-codicon void-codicon-italic" />
					</button>
					<button onClick={toggleUnderline} title="Underline (Ctrl+U)" className="void-draft-editor-toolbar-btn">
						<i className="void-codicon void-codicon-underline" />
					</button>
				</div>
				...
				{/* Lists */}
				<div className="void-draft-editor-toolbar-group">
					<button onClick={toggleBulletList} title="Bullet list" className="void-draft-editor-toolbar-btn">
						<i className="void-codicon void-codicon-list-unordered" />
					</button>
					<button onClick={toggleOrderedList} title="Numbered list" className="void-draft-editor-toolbar-btn">
						<i className="void-codicon void-codicon-list-ordered" />
					</button>
				</div>
			</div>
        ...
        className="void-draft-editor-content-wrapper void-void-scrollbar void-draft-editor-content"
        spellCheck
        style={{
          minHeight: '200px',
          padding: '12px',
