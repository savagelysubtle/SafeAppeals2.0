    ...
    <>
          ...
          <div
            ...
            onMouseLeave={() => setImportHovered(false)}>
						...
						<i
              className="void-codicon void-codicon-folder-opened"
              style={{ fontSize: "14px" }} />
              ...
              title={isIdle ? "Start recording" : "Stop recording"}>
							...
							<i
                className={`void-codicon ${isIdle ? "void-codicon-circle-filled" : "void-codicon-primitive-square"}`}
            ...
            onMouseLeave={() => setPauseHovered(false)}>
						...
						<i
              className={`void-codicon ${isPaused ? "void-codicon-play" : "void-codicon-debug-pause"}`}
              style={{ fontSize: "14px" }} />
