...
export const EventEditor: React.FC<EventEditorProps> = ({
  ...
  return (
    ...
    <div
      ...
      {/* Modal Card */}
			<div
        className="void-w-full void-max-w-lg void-rounded-xl void-shadow-2xl void-transition-all void-duration-200 void-flex void-flex-col"
        style={{
          ...modalStyle,
          height: '680px',
          maxHeight: '90vh'
        ...
        {/* Header */}
				<div
          className="void-flex void-items-center void-justify-between void-px-6 void-py-4 void-rounded-t-xl"
          style={{ borderBottom: '1px solid var(--vscode-panel-border)' }}>
          
          <div className="void-flex void-items-center void-gap-3">
            <div
              className="void-w-10 void-h-10 void-rounded-lg void-flex void-items-center void-justify-center"
              style={{ backgroundColor: 'var(--vscode-button-secondaryBackground)' }}>
              
              <i className="void-codicon void-codicon-calendar" style={{ color: 'var(--vscode-button-background)', fontSize: '18px' }} />
            </div>
            <div>
              ...
              {isFirstEvent &&
              <p className="void-text-xs" style={labelMutedStyle}>
            ...
            <i className="void-codicon void-codicon-close" />
				...
				{/* Form */}
        <form onSubmit={handleSubmit} className="void-flex void-flex-col void-flex-1" style={{ minHeight: 0 }}>
          {/* Scrollable content - always shows scrollbar */}
          <div
            className="void-p-6 void-space-y-5 void-overflow-y-auto void-flex-1 void-void-scrollbar"
            style={{
              minHeight: 0,
              scrollbarGutter: 'stable'
					...
					{/* Title */}
          <div className="void-grid void-gap-2">
            <label className="void-text-sm void-font-medium" style={labelStyle}>
              Title <span style={{ color: 'var(--vscode-button-background)' }}>*</span>
                ...
                required
                autoFocus
                className="void-h-10 void-w-full void-rounded-lg void-px-3 void-text-sm void-transition-all void-outline-none"
                style={inputStyle} />
          ...
          <div className="void-grid void-grid-cols-2 void-gap-4">
            ...
            <div className="void-grid void-gap-2">
              <label className="void-text-sm void-font-medium" style={labelMutedStyle}>
                End Date <span style={{ color: 'var(--vscode-disabledForeground)' }}>(optional)</span>
                  ...
                  style={inputStyle} />
					...
					{/* Category */}
          <div className="void-grid void-gap-2">
            <label className="void-text-sm void-font-medium" style={labelStyle}>Category</label>
              ...
              {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className="void-px-3 void-py-1.5 void-rounded-lg void-text-xs void-font-medium void-transition-all"
                      style={{
					...
					{/* Description */}
          <div className="void-grid void-gap-2">
            <label className="void-text-sm void-font-medium" style={labelMutedStyle}>Description</label>
						<textarea
                value={description}
                onChange={(e) => setDescription(e.target.value)}
                placeholder="Add details about this event..."
                rows={3}
                className="void-w-full void-rounded-lg void-px-3 void-py-2 void-text-sm void-transition-all void-outline-none void-resize-none"
                style={inputStyle} />
          ...
          {/* Deadline Toggle */}
          <div
              className="void-rounded-lg void-p-4"
              style={buttonSecondaryStyle}>
              
            <label className="void-flex void-items-center void-gap-3 void-cursor-pointer">
              <div
                  className="void-relative void-w-10 void-h-6 void-rounded-full void-transition-colors void-cursor-pointer"
                  style={{ backgroundColor: isDeadline ? 'var(--vscode-button-background)' : 'var(--vscode-panel-border)' }}
                  onClick={() => setIsDeadline(!isDeadline)}>
                  
                <div
                    className="void-absolute void-top-1 void-w-4 void-h-4 void-rounded-full void-transition-transform"
                    style={{
              ...
              <div>
                <span className="void-text-sm void-font-medium" style={labelStyle}>
								This is a deadline
							</span>
                <p className="void-text-xs" style={labelMutedStyle}>
            ...
            {isDeadline &&
              <div className="void-mt-4 void-pt-4 void-space-y-3" style={{ borderTop: '1px solid var(--vscode-panel-border)' }}>
                <label className="void-flex void-items-center void-gap-3 void-cursor-pointer">
									<input
                    type="checkbox"
                    checked={isComplete}
                    onChange={(e) => setIsComplete(e.target.checked)}
                    className="void-w-4 void-h-4 void-rounded"
                    style={{ accentColor: 'var(--vscode-button-background)' }} />
                  
                  <span className="void-text-sm" style={labelMutedStyle}>Mark as complete</span>
								</label>

                <div className="void-grid void-gap-2">
                  <label className="void-text-xs void-font-medium" style={labelMutedStyle}>
                    ...
                    placeholder="7, 3, 1"
                    className="void-h-9 void-w-full void-rounded-lg void-px-3 void-text-sm void-transition-all void-outline-none"
                    style={inputStyle} />
					...
					{/* Tags */}
          <div className="void-grid void-gap-2">
            <label className="void-text-sm void-font-medium" style={labelMutedStyle}>Tags</label>
						<input
                type="text"
                value={tagsInput}
            ...
            <p className="void-text-xs" style={{ color: 'var(--vscode-disabledForeground)' }}>Separate tags with commas</p>
          </div>
          ...
          <div
            ...
            <div className="void-flex void-items-center void-justify-between void-mb-3">
              <div className="void-flex void-items-center void-gap-2">
                <i className="void-codicon void-codicon-file-symlink-file" style={{ color: 'var(--vscode-button-background)', fontSize: '14px' }} />
                <span className="void-text-sm void-font-medium" style={labelStyle}>
                  Linked Documents
                </span>
                {linkedDocuments.length > 0 &&
                  <span
                    className="void-text-xs void-px-1.5 void-py-0.5 void-rounded-full"
              ...
              <button
                  ...
                  className="void-text-xs void-px-3 void-py-1.5 void-rounded-lg void-flex void-items-center void-gap-1.5 void-transition-all"
                  style={buttonPrimaryStyle}>
                  
                <i className="void-codicon void-codicon-add" style={{ fontSize: '12px' }} />
                {linkedDocuments.length === 0 ? 'Link Documents' : 'Manage'}
              </button>
            </div>

            {linkedDocuments.length > 0 ?
              <div className="void-space-y-2 void-max-h-32 void-overflow-y-auto void-void-scrollbar">
                {linkedDocuments.slice(0, 5).map((uri) => {
                  ...
                  return (
                    <div
                      key={uri}
                      className="void-flex void-items-center void-gap-2 void-px-3 void-py-2 void-rounded-lg"
                      style={{ backgroundColor: 'var(--vscode-editor-background)' }}>
                      
                      <i className={`void-codicon void-codicon-${icon}`} style={{ color: colorVar, fontSize: '14px' }} />
                      <span className="void-text-sm void-truncate void-flex-1" style={labelMutedStyle}>
                        {fileName}
                      </span>
                      <button
                        type="button"
                        onClick={() => handleUnlinkDocument(uri)}
                        className="void-text-xs void-px-1.5 void-py-0.5 void-rounded void-transition-colors"
                        style={{ color: 'var(--vscode-errorForeground)' }}>
                        
                        <i className="void-codicon void-codicon-close" style={{ fontSize: '12px' }} />
                      </button>
                    </div>);
                ...
                <button
                  type="button"
                  onClick={() => setShowDocumentPicker(true)}
                  className="void-text-xs void-w-full void-py-1.5 void-rounded-lg"
              ...
              <p className="void-text-xs" style={{ color: 'var(--vscode-disabledForeground)' }}>
          ...
          <div
            className="void-flex void-justify-end void-gap-3 void-px-6 void-py-4 void-flex-shrink-0"
            style={{ borderTop: '1px solid var(--vscode-panel-border)' }}>
              ...
              style={buttonSecondaryStyle}>
						...
						<button
              type="submit"
              className="void-px-5 void-py-2 void-rounded-lg void-text-sm void-font-semibold void-transition-all"
              style={buttonPrimaryStyle}>
