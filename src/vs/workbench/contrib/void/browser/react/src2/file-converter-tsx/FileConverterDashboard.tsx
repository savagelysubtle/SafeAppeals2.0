...
export const FileConverterDashboard: React.FC = () => {
      ...
      case "complete":
        return (
          <div className="void-flex void-flex-col void-items-center void-justify-center void-h-full void-p-8">
						<div className={`void-w-16 void-h-16 void-rounded-full void-flex void-items-center void-justify-center void-mb-6 ${currentResult?.success ? "void-bg-green-500/20" : "void-bg-red-500/20"}`}>
							<span className={`void-text-3xl ${currentResult?.success ? "void-text-green-500" : "void-text-red-500"}`}>
								{currentResult?.success ? '✓' : '✗'}
							</span>
						</div>
						<h3 className="void-text-xl void-font-semibold void-text-void-fg-1 void-mb-2">
							{currentResult?.success ? "Conversion Complete!" : "Conversion Failed"}
						</h3>
						{currentResult?.success ?
            <div className="void-text-center void-mb-8">
								<p className="void-text-void-fg-3 void-mb-4">Your file has been successfully converted.</p>
								<div className="void-flex void-gap-3 void-justify-center">
									<button
                  onClick={() => openFile(currentResult.output_path!)}
                  className="void-px-4 void-py-2 void-bg-void-bg-2 void-text-void-fg-1 void-rounded hover:void-bg-void-bg-2-hover void-transition-colors void-text-sm void-flex void-items-center void-gap-2">
            ...
            <div className="void-bg-red-500/10 void-border void-border-red-500/20 void-rounded-lg void-p-4 void-mb-8 void-max-w-md void-w-full">
								<p className="void-text-red-400 void-text-sm void-text-center">{currentResult?.error || "An unknown error occurred."}</p>
							</div>
            }
						<button onClick={handleNewConversion} className="void-px-6 void-py-3 void-bg-void-button-primary void-text-void-button-primary-text void-rounded-lg void-font-medium hover:void-bg-void-button-primary-hover void-transition-all void-flex void-items-center void-gap-2">
  ...
  return (
    <div
      className={`void-void-scope void-h-full void-flex void-flex-col void-bg-void-bg-1 ${isDragging ? "void-bg-blue-500/10" : ""}`}
      onDragOver={handleDragOver}
      onDragLeave={handleDragLeave}
      onDrop={handleDrop}>
      
			{/* Header */}
			<div className="void-flex void-items-center void-justify-between void-p-4 void-border-b void-border-void-border-2 void-bg-void-bg-2 void-shrink-0">
				<div className="void-flex void-items-center void-gap-3">
					<div className="void-w-8 void-h-8 void-bg-void-button-primary void-rounded-md void-flex void-items-center void-justify-center void-text-void-button-primary-text">⇄</div>
					<div>
						<h2 className="void-text-base void-font-bold void-text-void-fg-1 void-leading-none">Transmutations</h2>
						<p className="void-text-xs void-text-void-fg-3 void-mt-1">AiChemist File Converter</p>
					</div>
				</div>
			</div>

			{/* Main Content */}
			<div className="void-flex-1 void-overflow-y-auto void-custom-scrollbar">
				{renderContent()}
			</div>

			{/* History Section */}
			{history.length > 0 && currentStep === "select" &&
      <div className="void-border-t void-border-void-border-2 void-bg-void-bg-2 void-shrink-0 void-overflow-y-auto void-custom-scrollbar" style={{ maxHeight: '30%' }}>
			...
			{/* Drag Overlay */}
			{isDragging &&
      <div className="void-absolute void-inset-0 void-bg-blue-500/20 void-backdrop-blur-sm void-flex void-items-center void-justify-center void-z-50 void-border-4 void-border-void-button-primary void-border-dashed void-m-4 void-rounded-xl">
					<div className="void-text-center void-pointer-events-none">
						<p className="void-text-4xl void-mb-4">📄</p>
						<p className="void-text-2xl void-font-bold void-text-void-fg-1">Drop file to convert</p>
					</div>
				</div>
      }
		</div>);
