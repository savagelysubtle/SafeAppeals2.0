...
Generate the reply content only, formatted as HTML paragraphs.`;
    ...
    return (
      <div
        ...
        style={containerStyle}>
            ...
            className="void-px-8 void-py-3 void-font-semibold void-text-base void-transition-all void-duration-200 hover:void-scale-105"
            style={{
              ...buttonPrimaryStyle,
              padding: "12px 32px"
            }}>
					...
					<p className="void-mt-6 void-text-sm" style={descriptionStyle}>
  ...
  return (
    <div className="void-h-full void-flex void-flex-col" style={containerStyle}>
			{/* Toolbar */}
			<EmailToolbar
      ...
      <EmailFilters
        ...
        onCaseFolderChange={setSelectedCaseFolder} />
			...
			<div className="void-void-scrollbar void-flex-1 void-overflow-y-auto void-p-4">
				{displayMode === "flat" ?
        ...
        <div
          className={
          viewMode === "compact" ? "void-space-y-1 void-max-w-4xl void-mx-auto" : "void-space-y-3 void-max-w-4xl void-mx-auto"}>
        ...
        <div className="void-space-y-3 void-max-w-4xl void-mx-auto">
