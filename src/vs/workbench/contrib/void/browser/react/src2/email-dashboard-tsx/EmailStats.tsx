...
const StatCard: React.FC<StatCardProps> = ({ icon, label, value, accentColor }) => {
  return (
    <div
      className="void-flex void-items-center void-gap-3 void-px-4 void-py-2 void-transition-all"
      style={statCardStyle}>
      
			<i
        className={`void-codicon ${icon}`}
        style={{
          ...
          fontSize: '16px'
			...
			<div className="void-flex void-flex-col">
				<span
          className="void-text-lg void-font-semibold void-leading-tight"
...
export const EmailStats: React.FC<EmailStatsProps> = ({ stats }) => {
  return (
    <div
      className="void-flex void-items-center void-gap-4 void-p-3"
      style={statsBarStyle}>
