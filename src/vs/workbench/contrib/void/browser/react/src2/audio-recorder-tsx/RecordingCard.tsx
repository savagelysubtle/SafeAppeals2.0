    ...
    <div style={cardStyle}>
          ...
          <div
            ...
            onDoubleClick={handleDoubleClick}>
							...
							<i
              className={`void-codicon ${recording.isImported ? "void-codicon-folder-opened" : "void-codicon-record"}`}
          ...
          <i
            className="void-codicon void-codicon-loading void-codicon-modifier-spin"
            style={{ fontSize: "10px" }} />
      ...
      <div style={transcriptPreviewStyle}>
          ...
          <button
            ...
            title="Transcribe with Whisper AI">
							...
							<i className="void-codicon void-codicon-symbol-string" />
							Transcribe
						</button>
          }
          ...
          <div style={dropdownStyle}>
              ...
              title="Export transcript">
								...
								<i className="void-codicon void-codicon-export" />
								Export
								<i
          ...
          title={confirmDelete ? "Click again to confirm" : "Delete recording"}>
					...
					<i className="void-codicon void-codicon-trash" />
