...
/**
 * Working copy implementation for XLSX Rust Viewer files to enable VSCode auto-save integration
 */
export class XLSXRustWorkingCopy extends Disposable implements IWorkingCopy {
	readonly typeId = 'void.xlsxRust';
	...
	async save(options?: ISaveOptions): Promise<boolean> {
		if (!this._saveHandler) {
			console.warn('[XLSXRustWorkingCopy] No save handler registered');
			return false;
		}
		...
		try {
			...
			console.error('[XLSXRustWorkingCopy] Save failed:', error);
			return false;
		}
	}
