...
export class RAGContextService implements IRAGContextService {
	 ...
	 */
	private applyMMRReranking(results: SearchResult[], lambda: number = 0.7, maxResults: number = 8): SearchResult[] {
	 ...
	 */
	private calculateChunkSimilarity(text1: string, text2: string): number {
