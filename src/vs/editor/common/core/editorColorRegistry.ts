...
export const editorCursorForeground = registerColor('editorCursor.foreground', { dark: '#AEAFAD', light: Color.black, hcDark: Color.white, hcLight: '#0B3D0B' }, nls.localize('caret', 'Color of the editor cursor.'));
