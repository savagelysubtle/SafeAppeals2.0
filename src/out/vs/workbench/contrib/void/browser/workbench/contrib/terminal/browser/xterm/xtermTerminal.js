...
let XtermTerminal = (() => {
    ...
    let __refreshLigaturesAddon_decorators;
    let __refreshImageAddon_decorators;
    return class XtermTerminal extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __refreshLigaturesAddon_decorators = [debounce(100)];
            __refreshImageAddon_decorators = [debounce(100)];
            __esDecorate(this, null, __refreshLigaturesAddon_decorators, { kind: "method", name: "_refreshLigaturesAddon", static: false, private: false, access: { has: obj => "_refreshLigaturesAddon" in obj, get: obj => obj._refreshLigaturesAddon }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, __refreshImageAddon_decorators, { kind: "method", name: "_refreshImageAddon", static: false, private: false, access: { has: obj => "_refreshImageAddon" in obj, get: obj => obj._refreshImageAddon }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        _configurationService = __runInitializers(this, _instanceExtraInitializers);
