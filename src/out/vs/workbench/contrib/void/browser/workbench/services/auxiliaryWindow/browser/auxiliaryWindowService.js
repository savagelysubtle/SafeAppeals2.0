...
export class AuxiliaryWindow extends BaseWindow {
    window;
    container;
...
export class BrowserAuxiliaryWindowService extends Disposable {
    layoutService;
    dialogService;
    configurationService;
    telemetryService;
    ...
    static WINDOW_IDS = getWindowId(mainWindow) + 1; // start from the main window ID + 1
