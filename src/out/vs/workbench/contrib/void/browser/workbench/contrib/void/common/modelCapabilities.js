...
const extensiveModelOptionsFallback = (modelName, fallbackKnownValues) => {
    ...
    if (lower.includes('claude-4') && lower.includes('opus'))
        return toFallback(anthropicModelOptions, 'claude-opus-4-20250514');
    if (lower.includes('claude-4') && lower.includes('haiku'))
        return toFallback(anthropicModelOptions, 'claude-haiku-4-5');
    if (lower.includes('claude-4-5') || lower.includes('claude-sonnet-4-5') || (lower.includes('claude-4') && lower.includes('sonnet')))
        return toFallback(anthropicModelOptions, 'claude-sonnet-4-5');
    ...
    if (lower.includes('gpt') && lower.includes('5'))
...
const anthropicSettings = {
    ...
    modelOptionsFallback: (modelName) => {
        ...
        if (lower.includes('claude-4-5') || lower.includes('claude-sonnet-4-5') || lower.includes('claude-4.5'))
            fallbackName = 'claude-sonnet-4-5';
        if (lower.includes('claude-haiku-4-5') || lower.includes('claude-haiku-4.5'))
            fallbackName = 'claude-haiku-4-5';
        if (lower.includes('claude-4') && lower.includes('opus'))
            fallbackName = 'claude-opus-4-20250514';
        if (lower.includes('claude-4') && lower.includes('sonnet') && !fallbackName)
