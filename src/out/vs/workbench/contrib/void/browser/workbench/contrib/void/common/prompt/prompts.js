...
export const builtinTools = {
    ...
    create_file_or_folder: {
        ...
        description: `Create a TEXT file or folder at the given path. To create a folder, the path MUST end with a trailing slash. WARNING: This tool only creates EMPTY files. Do NOT use this for DOCX, XLSX, or other document files - use edit_document instead to create documents with content.`,
        params: {
...
export const chat_userMessageContent = async (instructions, currSelns, opts) => {
    ...
    if (selnsStr) {
        ...
        const hasPDFExcerpts = (currSelns ?? []).some(s => s.type === 'File' && s.language === 'pdf' && s.state.ragContext);
