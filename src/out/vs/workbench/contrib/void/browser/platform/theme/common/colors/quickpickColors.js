...
export const pickerGroupForeground = registerColor('pickerGroup.foreground', { dark: '#A6E22E', light: '#4F9E1F', hcDark: Color.white, hcLight: '#0B3D0B' }, nls.localize('pickerGroupForeground', "Quick picker color for grouping labels."));
export const pickerGroupBorder = registerColor('pickerGroup.border', { dark: '#1F3A12', light: '#B7E67A', hcDark: Color.white, hcLight: '#0B3D0B' }, nls.localize('pickerGroupBorder', "Quick picker color for grouping borders."));
