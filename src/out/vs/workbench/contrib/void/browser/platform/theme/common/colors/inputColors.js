...
export const inputActiveOptionBorder = registerColor('inputOption.activeBorder', { dark: '#A6E22E', light: '#A6E22E', hcDark: contrastBorder, hcLight: contrastBorder }, nls.localize('inputBoxActiveOptionBorder', "Border color of activated options in input fields."));
...
export const inputValidationInfoBorder = registerColor('inputValidation.infoBorder', { dark: '#A6E22E', light: '#A6E22E', hcDark: contrastBorder, hcLight: contrastBorder }, nls.localize('inputValidationInfoBorder', "Input validation border color for information severity."));
...
export const buttonBackground = registerColor('button.background', { dark: '#A6E22E', light: '#A6E22E', hcDark: null, hcLight: '#A6E22E' }, nls.localize('buttonBackground', "Button background color."));
