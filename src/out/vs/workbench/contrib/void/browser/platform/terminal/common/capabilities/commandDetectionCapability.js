...
let CommandDetectionCapability = (() => {
    let _classSuper = Disposable;
    let _instanceExtraInitializers = [];
    let __handleCursorMove_decorators;
    return class CommandDetectionCapability extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __handleCursorMove_decorators = [debounce(500)];
            __esDecorate(this, null, __handleCursorMove_decorators, { kind: "method", name: "_handleCursorMove", static: false, private: false, access: { has: obj => "_handleCursorMove" in obj, get: obj => obj._handleCursorMove }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        _terminal = __runInitializers(this, _instanceExtraInitializers);
        _logService;
