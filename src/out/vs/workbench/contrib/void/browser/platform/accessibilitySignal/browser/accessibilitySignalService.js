...
export class AccessibilitySignalService extends Disposable {
    configurationService;
    accessibilityService;
    telemetryService;
    _serviceBrand;
    sounds = new Map();
    screenReaderAttached = observableFromEvent(this, this.accessibilityService.onDidChangeScreenReaderOptimized, () => /** @description accessibilityService.onDidChangeScreenReaderOptimized */ this.accessibilityService.isScreenReaderOptimized());
    sentTelemetry = new Set();
    ...
    _signalEnabledState = new CachedFunction({ getCacheKey: getStructuralKey }, (arg) => {
