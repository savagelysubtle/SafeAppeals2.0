...
let ListView = (() => {
    ...
    let _get_onMouseClick_decorators;
    let _get_onMouseDblClick_decorators;
    let _get_onMouseMiddleClick_decorators;
    let _get_onMouseUp_decorators;
    let _get_onMouseDown_decorators;
    let _get_onMouseOver_decorators;
    let _get_onMouseMove_decorators;
    let _get_onMouseOut_decorators;
    let _get_onContextMenu_decorators;
    let _get_onTouchStart_decorators;
    let _get_onTap_decorators;
    return class ListView {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _get_onMouseClick_decorators = [memoize];
            _get_onMouseDblClick_decorators = [memoize];
            _get_onMouseMiddleClick_decorators = [memoize];
            _get_onMouseUp_decorators = [memoize];
            _get_onMouseDown_decorators = [memoize];
            _get_onMouseOver_decorators = [memoize];
            _get_onMouseMove_decorators = [memoize];
            _get_onMouseOut_decorators = [memoize];
            _get_onContextMenu_decorators = [memoize];
            _get_onTouchStart_decorators = [memoize];
            _get_onTap_decorators = [memoize];
            __esDecorate(this, null, _get_onMouseClick_decorators, { kind: "getter", name: "onMouseClick", static: false, private: false, access: { has: obj => "onMouseClick" in obj, get: obj => obj.onMouseClick }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseDblClick_decorators, { kind: "getter", name: "onMouseDblClick", static: false, private: false, access: { has: obj => "onMouseDblClick" in obj, get: obj => obj.onMouseDblClick }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseMiddleClick_decorators, { kind: "getter", name: "onMouseMiddleClick", static: false, private: false, access: { has: obj => "onMouseMiddleClick" in obj, get: obj => obj.onMouseMiddleClick }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseUp_decorators, { kind: "getter", name: "onMouseUp", static: false, private: false, access: { has: obj => "onMouseUp" in obj, get: obj => obj.onMouseUp }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseDown_decorators, { kind: "getter", name: "onMouseDown", static: false, private: false, access: { has: obj => "onMouseDown" in obj, get: obj => obj.onMouseDown }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseOver_decorators, { kind: "getter", name: "onMouseOver", static: false, private: false, access: { has: obj => "onMouseOver" in obj, get: obj => obj.onMouseOver }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseMove_decorators, { kind: "getter", name: "onMouseMove", static: false, private: false, access: { has: obj => "onMouseMove" in obj, get: obj => obj.onMouseMove }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onMouseOut_decorators, { kind: "getter", name: "onMouseOut", static: false, private: false, access: { has: obj => "onMouseOut" in obj, get: obj => obj.onMouseOut }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onContextMenu_decorators, { kind: "getter", name: "onContextMenu", static: false, private: false, access: { has: obj => "onContextMenu" in obj, get: obj => obj.onContextMenu }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onTouchStart_decorators, { kind: "getter", name: "onTouchStart", static: false, private: false, access: { has: obj => "onTouchStart" in obj, get: obj => obj.onTouchStart }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _get_onTap_decorators, { kind: "getter", name: "onTap", static: false, private: false, access: { has: obj => "onTap" in obj, get: obj => obj.onTap }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        virtualDelegate = __runInitializers(this, _instanceExtraInitializers);
        ...
        onDidChangeContentWidth = Event.latch(this._onDidChangeContentWidth.event, undefined, this.disposables);
