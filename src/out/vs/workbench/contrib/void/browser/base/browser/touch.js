...
let Gesture = (() => {
    ...
    let _static_isTouchDevice_decorators;
    return class Gesture extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _static_isTouchDevice_decorators = [memoize];
            __esDecorate(this, null, _static_isTouchDevice_decorators, { kind: "method", name: "isTouchDevice", static: true, private: false, access: { has: obj => "isTouchDevice" in obj, get: obj => obj.isTouchDevice }, metadata: _metadata }, null, _staticExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        static SCROLL_FRICTION = (__runInitializers(this, _staticExtraInitializers), -0.005);
        static INSTANCE;
