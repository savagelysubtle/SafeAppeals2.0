...
let ChannelClient = (() => {
    ...
    let _get_onDidInitializePromise_decorators;
    return class ChannelClient {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _get_onDidInitializePromise_decorators = [memoize];
            __esDecorate(this, null, _get_onDidInitializePromise_decorators, { kind: "getter", name: "onDidInitializePromise", static: false, private: false, access: { has: obj => "onDidInitializePromise" in obj, get: obj => obj.onDidInitializePromise }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        protocol = __runInitializers(this, _instanceExtraInitializers);
        isDisposed = false;
