...
export class XLSXRustViewerInput extends EditorInput {
	static readonly TYPE_ID = 'void.xlsxRustViewerInput';
	static readonly EDITOR_ID = 'void.xlsxRustViewer';
	...
	override get typeId(): string {
		return XLSXRustViewerInput.TYPE_ID;
	}

	override get editorId(): string {
		return XLSXRustViewerInput.EDITOR_ID;
	}

	override get capabilities() {
		return 0; // Read-only for now, will support write later
	}
	...
	override matches(otherInput: EditorInput | IUntypedEditorInput): boolean {
		if (otherInput instanceof XLSXRustViewerInput) {
