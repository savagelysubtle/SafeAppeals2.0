...
class RAGConfigurationManager {
  ...
  async updateConfiguration(newConfig: Partial<RAGServiceConfig>): Promise<void> {
  ...
  private async applyConfigurationChanges(changes: Partial<RAGServiceConfig>): Promise<void> {
